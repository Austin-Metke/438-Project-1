import { getStockHistory } from '@/api/stock-data';
...
export default function BuySell() {
  ...
  <Text style={styles.price}>
    {price !== null ? `Current Price: $${price.toFixed(2)}` : 'Loading price...'}
  </Text>
  ...
  <Text style={styles.instructionText}>Enter number of shares to affect</Text>
  <TextInput
